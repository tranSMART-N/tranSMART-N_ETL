...
$KETTLE_DIR/kitchen.sh /rep:1 /dir="/Search" /job:"ETL.snpAnalysis.load_analysis_metadata_lz_to_biomart" /user:admin /pass:admin -log=<path to your logs folder>/load_analysis_metadata_${log_date}.log \
--param:ETL_ID=$etl_id
