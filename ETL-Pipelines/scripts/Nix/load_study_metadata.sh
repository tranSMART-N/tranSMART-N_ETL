...
$KETTLE_DIR/kitchen.sh /rep:1 /dir="/Metadata" /job:"ETL.metadata.Load_Study_Metadata" /user:admin /pass:admin \
-log=<path to your logs folder>/load_study_metadata_$log_date.log \
