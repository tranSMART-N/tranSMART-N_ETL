...
%KETTLE_DIR%\kitchen.bat /rep:1 /dir="/Util" /job:"ETL.Util.manage_security_for_study" /user:admin /pass:admin ^
-param:STUDY_ID=%studyID%  ^
-param:SECURE_TYPE=%secureType% ^
-param:STUDY_ENV=%studyEnv% ^
-param:LOG_LOCATION=%logLocation% ^
-param:LOG_PREFIX=%logPrefix%
exit /b