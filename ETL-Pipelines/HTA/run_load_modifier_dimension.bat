...
%KETTLE_DIR%\kitchen.bat /rep:1 /dir="/Metadata" /job:"ETL.metadata.load_modifiers" /user:admin /pass:admin ^
-param:DATA_LOCATION=%dataLocation%  ^
-param:LOAD_TYPE=%loadType% ^
-param:MODIFIER_FILENAME=%modifierFile% ^
-param:SORT_DIR=%dataLocation% 
rem NOTE NOTE NOTE
