...
CREATE SEQUENCE tm_cz.emt_temp_seq as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.rtqalimits_testid_seq as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.rtqastatslist_testid_seq as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_child_rollup_id as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz_data as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz_data_file as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz_dw_version_id as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz_job_audit as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz_job_id as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz_job_master as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz_job_message as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz_person_id as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz_test as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_cz_test_category as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;

CREATE SEQUENCE tm_cz.seq_probeset_id as bigint INCREMENT BY 1 MINVALUE 1 NO MAXVALUE START WITH 1;
